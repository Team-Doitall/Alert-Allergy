...
public class AlertAllergyApplication {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SpringApplication.run(AlertAllergyApplication.class, args);
    }
