...
public class UserSettings extends AUserSettings {
    ...
    public UserSettings(@Nullable String settingId, String language, Map<String,Object> notificationPreferences, Map<String, Object> displayPreferences, Timestamp createdAt, Timestamp updatedAt,  Users user) {
